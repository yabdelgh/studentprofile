...
public class AppApplication {
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        modelPermissions.add(new ModelPermission("StudentProfile"));
        modelPermissions.add(new ModelPermission("Experience"));
        modelPermissions.add(new ModelPermission("Education"));
